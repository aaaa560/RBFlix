...
use egui::Image;
use gstreamer::prelude::{Cast, ElementExt, ElementExtManual, GstBinExt};
...
impl RambleyFlixApp {
    ...
    pub fn load_user_data(&mut self) {
    ...
    pub fn load_custom_users(&mut self) {
    ...
    pub fn handle_failed_login(&mut self) {
    ...
    pub fn save_to_history(&self, url: &str) {
    ...
    pub fn start_recommendations_search(&mut self, video: VideoResult) {
    ...
    pub fn load_thumbnail(&self, video_url: &str, thumbnail_url: &str) {
    ...
    pub fn create_thumbnail_texture(ctx: &egui::Context, image_data: &[u8]) -> Option<TextureHandle> {
    ...
    pub fn handle_async_messages(&mut self, ctx: &egui::Context) {
    ...
    pub fn show_advanced_search(&mut self, ui: &mut egui::Ui) {
    ...
    pub fn show_favorites_in_sidebar(&mut self, ui: &mut egui::Ui, _ctx: &egui::Context) {
    ...
    pub fn show_playlists_section(&mut self, ui: &mut egui::Ui) {
    ...
    pub fn show_search_screen(&mut self, ui: &mut egui::Ui, _ctx: &egui::Context) {
    ...
    pub fn show_results_screen(&mut self, ui: &mut egui::Ui, ctx: &egui::Context) {
        ui.vertical(|ui| {
            ui.horizontal(|ui| {
    ...
    pub fn show_video_item(&mut self, ui: &mut egui::Ui, ctx: &egui::Context, video: &VideoResult) {
        ui.group(|ui| {
            ui.horizontal(|ui| {
    ...
    pub fn show_compact_recommendation_item(
        &mut self,
        ui: &mut egui::Ui,
        _ctx: &egui::Context,
        video: &VideoResult,
    ...
    pub fn stop_video_playback(&mut self) {
    ...
    pub fn show_playing_video_screen(&mut self, ui: &mut egui::Ui, ctx: &egui::Context) {
        ui.vertical(|ui| {
            // Header
            ui.horizontal(|ui| {
    ...
    pub fn show_netflix_screen(&mut self, ui: &mut egui::Ui) {
        ui.vertical_centered(|ui| {
            ui.add_space(50.0);
    ...
    pub fn show_history_screen(&mut self, ui: &mut egui::Ui) {
        ui.vertical(|ui| {
    ...
    pub fn show_downloads_screen(&mut self, ui: &mut egui::Ui) {
        ui.vertical(|ui| {
            if ui.button("🔙 Voltar ao Menu").clicked() {
                self.state = AppState::MainMenu;
            }
    ...
    pub fn show_settings_screen(&mut self, ui: &mut egui::Ui) {
        ui.vertical(|ui| {
    ...
    pub fn seek_video(&mut self, seconds: i64) {
        if let Some(tx) = &self.video_command_tx {
    ...
    pub fn download_video(&mut self, video: &VideoResult) {
        let download_dir = self.config_dir.join("downloads");
    ...
    pub fn update_last_watched(&mut self, video: &VideoResult, position: f32) {
    ...
    pub fn add_to_favorites(&mut self, video: &VideoResult) {
        let mut data = UserData::load(&self.config_dir);
    ...
    pub fn play_video(&mut self, video: VideoResult) {
    ...
    pub fn get_direct_video_url(url: &str) -> Result<String, String> {
    ...
    pub fn add_to_playlist(&mut self, video: &VideoResult, playlist_name: &str) {
    ...
    pub fn show_main_menu(&mut self, ui: &mut egui::Ui, _ctx: &egui::Context) {
        ui.vertical_centered(|ui| {
            ui.add_space(50.0);
    ...
    pub fn show_playlist_view(&mut self, ui: &mut egui::Ui) {
        ui.horizontal(|ui| {
            if ui.button("🔙 Voltar ao Menu").clicked() {
                self.state = AppState::MainMenu;
            }
    ...
    pub fn show_active_playlist_view(&mut self, ui: &mut egui::Ui, ctx: &egui::Context) {
        ui.horizontal(|ui| {
            if ui.button("🔙 Voltar").clicked() {
                self.state = AppState::PlaylistView;
            }
